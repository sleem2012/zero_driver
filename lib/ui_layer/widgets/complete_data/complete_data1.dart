...
class CompleteData1Widget extends StatelessWidget {
    ...
    return BlocBuilder<UploadCompleteDataCubit, UploadCompleteDataState>(
      builder: (context, state) {
        ...
        if (state is UploadCompleteDataInitial) {
          return InkWell(
            onTap: () {
              context.read<UploadCompleteDataCubit>().pickImage1(
                    context,
                  );
            },
            child: DocumentWidget(
              title: 'personal_id_front'.tr,
            ),
